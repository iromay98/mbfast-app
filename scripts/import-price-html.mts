...
const BRANDS: BrandSpec[] = [
  ...
  },
  {
    ...
    namespacePrefix: "mb-", // ライブ改修でmbd-系→mb-系（セルは無印）に統一された
    ns: "",
    searchAttr: "data-search",
    seriesAttr: "data-series",
    hasGrade: true,
    ...
    priceCells: [
      ...
      { key: "adblueCut", cls: "cell-price-adblue", label: "アドブルーカット" },
      { key: "ecuAdblue", cls: "cell-price-ecuadblue", label: "ECU+アドブルー" },
      { key: "dpfEgrNox", cls: "cell-price-dpf", label: "DPF/EGR/NOxカット" },
    ],
    columns: [
      { key: "car", label: "車種 (型式)", type: "text", order: 0 },
      { key: "grade", label: "グレード", type: "text", order: 1 },
      ...
      { key: "stage1Gain", label: "Stage1最大出力", labelHtml: "Stage1<br>最大出力", type: "output", order: 8 },
      { key: "labor", label: "脱着・殻割工賃", labelHtml: "脱着・殻割<br>工賃", type: "labor", order: 9 },
      { key: "shops", label: "対応店舗", type: "shops", order: 10 },
      { key: "remote", label: "リモート", type: "remote", order: 11 },
    ],
    jsonLdDescription:
